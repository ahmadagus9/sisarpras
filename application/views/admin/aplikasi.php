      ...
      <div class="box">
          <form class="form-horizontal" action="<?= base_url('index.php/admin/aplikasi/update/').$row['id'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-footer">
              <small><b><i><font color="red">*) Kosongkan jika tidak ingin diubah <br> NB : Logo yang dapat diupload yaitu berformat PNG, JPG dan JPEG ukuran maximal 5MB</font></i></b></small>
